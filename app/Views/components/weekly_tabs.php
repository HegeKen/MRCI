...
<div class="mdui-color-deep-orange-accent mdui-text-color-white">
    ...
    <div class="pc mdui-tab mdui-tab-centered">
      ...
      <a href="<?php echo base_url($locale);?>/weekly/" class="mdui-ripple mdui-tab-active mdui-text-capitalize"><i class="mdui-icon material-icons">developer_mode</i><label><?php echo lang('app.vl'); ?></label></a>
    ...
    <div class="mobile mdui-hidden">
      <div class="mdui-drawer mdui-drawer-left mdui-text-color-black-text" id="main-drawer">
        <ul class="mdui-list">
          ...
          <a href="<?php echo base_url($locale);?>/weekly/"><li class="mdui-list-item mdui-list-item-active"><i class="mdui-list-item-icon mdui-icon material-icons">developer_mode</i><div class="mdui-list-item-content"><?php echo lang('app.vl'); ?></div></li></a>
