...
<div class="mdui-color-deep-orange-accent mdui-text-color-white">
    ...
    <div class="pc mdui-tab mdui-tab-centered">
      <a href="<?php echo base_url($locale);?>/" class="mdui-ripple mdui-text-capitalize mdui-tab-active"><i class="mdui-icon material-icons">home</i><label><?php echo lang('app.hp'); ?></label></a>
      ...
      <a href="<?php echo base_url($locale);?>/sitelog" class="mdui-ripple mdui-text-capitalize"><i class="mdui-icon material-icons">update</i><label><?php echo lang('app.sl'); ?></label></a>
      ...
      <a href="<?php echo base_url($locale);?>/about" class="mdui-ripple mdui-text-capitalize"><i class="mdui-icon material-icons">perm_identity</i><label><?php echo lang('app.as'); ?></label></a>
      </div>
    <div class="mobile mdui-hidden">
      <div class="mdui-drawer mdui-drawer-left mdui-text-color-black-text" id="main-drawer">
        <ul class="mdui-list">
          <a href="<?php echo base_url($locale);?>/"><li class="mdui-list-item mdui-list-item-active"><i class="mdui-list-item-icon mdui-icon material-icons">home</i><div class="mdui-list-item-content"><?php echo lang('app.hp'); ?></div></li></a>
