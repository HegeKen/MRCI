  ...
  <div class="mobile mdui-hidden">
    ...
    <div class="mdui-bottom-nav mdui-bottom-nav-text-auto footer mdui-color-grey-100 ffm">
      <a href="<?php echo base_url($locale);?>/" class="mdui-ripple mdui-bottom-nav-active" mdui-tooltip="{content: '<?php echo lang('app.hp'); ?>'}"><i class="mdui-icon material-icons">home</i><label><?php echo lang('app.hp'); ?></label></a>
