...
<div class="mdui-color-deep-orange-accent mdui-text-color-white">
    ...
    <div class="pc mdui-tab mdui-tab-centered">
      ...
      <a href="<?php echo base_url($locale);?>/tools/" class="mdui-ripple mdui-tab-active mdui-text-capitalize"><i class="mdui-icon material-icons">computer</i><label><?php echo lang('app.tools'); ?></label></a>
    ...
    <div class="mobile mdui-hidden">
      <div class="mdui-drawer mdui-drawer-left mdui-text-color-black-text" id="main-drawer">
        <ul class="mdui-list">
          ...
          <a href="<?php echo base_url($locale);?>/tools/"><li class="mdui-list-item mdui-list-item-active"><i class="mdui-list-item-icon mdui-icon material-icons">computer</i><div class="mdui-list-item-content"><?php echo lang('app.tools'); ?></div></li></a>
