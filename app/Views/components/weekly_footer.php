  ...
  <div class="mobile mdui-hidden">
    ...
    <div class="mdui-bottom-nav mdui-bottom-nav-text-auto footer mdui-color-grey-100 ffm">
      ...
      <a href="<?php echo base_url($locale);?>/weekly/" class="mdui-ripple mdui-bottom-nav-active" mdui-tooltip="{content: '<?php echo lang('app.vl'); ?>'}"><i class="mdui-icon material-icons">developer_mode</i><label><?php echo lang('app.vl'); ?></label></a>
      ...
      <a href="<?php echo base_url($locale);?>/tools/" class="mdui-ripple" mdui-tooltip="{content: '<?php echo lang('app.tools'); ?>'}"><i class="mdui-icon material-icons">computer</i><label><?php echo lang('app.tools'); ?></label></a>
